...
(
	{  
        ...
        testBindingGetListener : function(){
            ...
            var l1 = function(){};
            var b1 = s.add(l1);
            YUITest.Assert.isUndefined(b1.listener); //make sure it's private
            YUITest.Assert.areSame(1, s.getNumListeners());
        ...
        testRemoveSingle : function(){
            ...
            var l1 = function(){YUITest.Assert.fail();};
        ...
        testRemoveSingleTwice : function(){
            ...
            var l = function(){YUITest.Assert.fail();};
        ...
        testRemoveDouble : function(){
            ...
            var l1 = function(){YUITest.Assert.fail();};
            var l2 = function(){YUITest.Assert.fail();};
        ...
        testRemoveAll : function(){
            ...
            s.add(function(){YUITest.Assert.fail();});
            s.add(function(){YUITest.Assert.fail();});
            s.addOnce(function(){YUITest.Assert.fail();});
            s.add(function(){YUITest.Assert.fail();});
            s.addOnce(function(){YUITest.Assert.fail();});
        ...
        testRemoveAll2 : function(){
            ...
            var b1 = s.add(function(){YUITest.Assert.fail();});
            var b2 = s.add(function(){YUITest.Assert.fail();});
            var b3 = s.addOnce(function(){YUITest.Assert.fail();});
            var b4 = s.add(function(){YUITest.Assert.fail();});
            var b5 = s.addOnce(function(){YUITest.Assert.fail();});
